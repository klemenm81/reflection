...
REFLECT_TYPE_START(Test)
	...
	REFLECT_METHOD(int, fooOverloaded, int)
	REFLECT_METHOD(int, fooOverloaded, float)
	REFLECT_METHOD(int, fooOverloaded, std::vector<int>, int)
	...
	REFLECT_METHOD(void, overload, int)
	REFLECT_METHOD(void, overloadEx, int) 
